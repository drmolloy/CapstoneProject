...
public class BracketViewer
{
    public static void main(String[] args)
    {
        ...
        JLabel winnerOne = new JLabel("Winner of "+teams.get(0).getName()+"and "+teams.get(15).getName());
        winnerOne.setBounds(150,30,200,50);
        first.add(winnerOne);
        JLabel winnerTwo = new JLabel("Winner of "+teams.get(7).getName()+"and "+teams.get(8).getName());
        winnerTwo.setBounds(150,105,200,50);
        first.add(winnerTwo);
        JLabel winnerThree = new JLabel("Winner of "+teams.get(3).getName()+" and "+teams.get(12).getName());
        winnerThree.setBounds(150,180,200,50);
        first.add(winnerThree);
        JLabel winnerFour = new JLabel("Winner of "+teams.get(4).getName()+"and "+teams.get(11).getName());
        winnerFour.setBounds(150,255,200,50);
        first.add(winnerFour);
        JLabel winnerFive = new JLabel("Winner of "+teams.get(1).getName()+"and "+teams.get(14).getName());
        winnerFive.setBounds(860,30,200,50);
        first.add(winnerFive);
        JLabel winnerSix = new JLabel("Winner of "+teams.get(6).getName()+"and "+teams.get(9).getName());
        winnerSix.setBounds(860,105,200,50);
        first.add(winnerSix);
        JLabel winnerSeven = new JLabel("Winner of "+teams.get(2).getName()+"and "+teams.get(13).getName());
        winnerSeven.setBounds(860,180,200,50);
        first.add(winnerSeven);
        JLabel winnerEight = new JLabel("Winner of "+teams.get(5).getName()+"and "+teams.get(10).getName());
        winnerEight.setBounds(860,255,200,50);
